...
<!-- main.jsp 메인 이미지, 콘텐츠  -->
    <div class="container">
      ...
      <div class="col-md-8 mx-auto text-left">
          <form class="needs-validation form-horizontal" novalidate="" name="fr" action="delMemberPro.jsp" method="post">
            ...
            <div class="from-group row">
                <div class="col-md mb-2 mb-md-0">
                    <input class="btn btn-primary btn-lg btn-block" type="submit" value="탈퇴">
                </div>
                <div class="col-md">
                    <input class="btn btn-outline-secondary btn-lg btn-block" type="reset" value="취소" onclick="history.back()">
                </div>
            </div>
