...
out.println(re_ref+"ref");

int re_lev = Integer.parseInt(request.getParameter("re_lev"));
int re_seq = Integer.parseInt(request.getParameter("re_seq"));
String oriSubject = "re :"+request.getParameter("subject");
...
<!-- 상단  -->
    <div class="container">
      ...
      <div class="my-5">
        <h1 class="h3 font-weight-normal">게시글 답글쓰기</h1>
		...
		<table class="table text-center">
	      <colgroup>
               ...
               <col width="40%">
				...
				<tr>
				<th class="">제목</th><td colspan="3"><input type="text" name="subject" class="form-control" value="<%=oriSubject %>"></td>
				</tr>
